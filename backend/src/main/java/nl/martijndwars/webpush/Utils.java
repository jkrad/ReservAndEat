...
public class Utils {
    ...
    /**
     * Get the uncompressed encoding of the public key point. The resulting
     * array should be 65 bytes length and start with 0x04 followed by the x and
     ...
     */
    public static PublicKey loadPublicKey(String encodedPublicKey) throws
